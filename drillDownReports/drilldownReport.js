...
function setTestSuiteName() {
    ...
    //alert(json.aoReportTestSuite.testDateTime);
        ...
        if (dropDownTestCase == 'All' && dropDownBrowser == 'All') {
            if (dropDownStatus == this.testCaseStatus) {
                newCollapse = generateHTML4Filters(this.testCase,
                    ...
                    this.aoTestCaseStep, index, this.testCaseID);
            }
...
function generateHTML4Filters(testCase, testCaseStatus, browser, website,
                              testVideoURL, omnitureTestCase, aoTestCaseStep, index, testCaseID) {
    ...
    if (envval.toLowerCase() == "devices") {
        if (browser == "realipadsafari@safari") {
            testCaseHeader = "Test Case Name: " + testCase + "_Device | Device: " + browserInfo[1] + " | Browser: Safari 8";
        }
        if (browser == "chromedriver") {
            testCaseHeader = "Test Case Name: " + testCase + "_Device | Device: " + browserInfo[1] + " | Browser: Chrome 40";
        }
