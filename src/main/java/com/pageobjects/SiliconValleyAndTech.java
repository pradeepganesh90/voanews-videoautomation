 ...
 *
 */
public class SiliconValleyAndTech {
	...
	public SiliconValleyAndTech(WebDriver driver, HashMap<String, String> AOValues, AutomateOnReport CR, Eyes eyes) {
		super();
		this.driver = driver;
	 ...
	 */
	public SiliconValleyAndTech validateVideoFiles(String typeOfStep, String stepDesc) {
		WebDriverWait wait= new WebDriverWait(driver,100);
		try {
			JavascriptExecutor js;
			if (driver instanceof JavascriptExecutor) {
				WebElement link = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id=\"warea-962\"]//a")));
		        link.click();
		        Thread.sleep(3000);
		        CR.TestCasePass(typeOfStep, stepDesc, "");
		        WebElement link1 = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"warea-887\"]/div/div[1]/ul/li/div/a/div")));
		        link1.click();
